...
#primeira posição de mensagem guarda a um contador e a segunda guarda a distancia total acumulada desse sinal
...
function reflectoMessage(tsp)
    ...
    while it < maxIt
        ...
        for i in collect(1:n)[1:n .∉ [lista]]
            ...
            append!(mensagemList, [vcat(mensagem[2]+tsp.weights[origemAtual, i], mensagem[2]+tsp.weights[origemAtual, i], lista[:], i)])
        end
